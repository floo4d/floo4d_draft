...
mod_current_algo = ('Algo.Fista',)# 'Applic_Fista', 'Applic_urqrd')#,   
mod_file = ("File.GifaFile",'File.HDF5File', 'File.Apex', 'File.csv')
mod_basicproc = ("NPKData", "FTICR", "Orbitrap")
mod_user = ('processing',)

list_of_modules =  mod_current_algo + mod_algo + mod_user + mod_basicproc + mod_file  + mod_util
#list_of_modules = ('File.csv',)

list_of_mails =  ["lionel.chiron@gmail.com"]  # []
